...
const CreatePin = ({ user }) => {
  ...
  return (
    <div className='flex flex-col justfy-center items-center mt-5 lg:h-4/5'>
      {fields && (
        <p className='text-red-500 mb-5 text-xl transition-all duration-150 ease-in'>Please fill in all the fields.</p>
      )}
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lb:p-5 p-3 lg:w-4/5 w-full'>
